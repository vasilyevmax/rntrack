...
//
// A here-document with a template for "makefile.dep"
//
var makefile_dep = function(){/*
# Microsoft Developer Studio Generated Dependency File, included by @@makefileName@@@@makefileExt@@
...
//
// A here-document with a template for perldep
//
var perldep = function(){/*
    "@@perl_incl@@\arpa\inet.h"\
    "@@perl_incl@@\av.h"\
    "@@perl_incl@@\buildinfo.h"\
    "@@perl_incl@@\config.h"\
    "@@perl_incl@@\cop.h"\
    "@@perl_incl@@\cv.h"\
    "@@perl_incl@@\dirent.h"\
    "@@perl_incl@@\dosish.h"\
    "@@perl_incl@@\embed.h"\
    "@@perl_incl@@\embedvar.h"\
    "@@perl_incl@@\extern.h"\
    "@@perl_incl@@\form.h"\
    "@@perl_incl@@\gv.h"\
    "@@perl_incl@@\handy.h"\
    "@@perl_incl@@\hv.h"\
    "@@perl_incl@@\intrpvar.h"\
    "@@perl_incl@@\iperlsys.h"\
    "@@perl_incl@@\mg.h"\
    "@@perl_incl@@\netdb.h"\
    "@@perl_incl@@\op.h"\
    "@@perl_incl@@\opcode.h"\
    "@@perl_incl@@\opnames.h"\
    "@@perl_incl@@\overload.h"\
    "@@perl_incl@@\pad.h"\
    "@@perl_incl@@\patchlevel.h"\
    "@@perl_incl@@\perl.h"\
    "@@perl_incl@@\perlapi.h"\
    "@@perl_incl@@\perlio.h"\
    "@@perl_incl@@\perlvars.h"\
    "@@perl_incl@@\perly.h"\
    "@@perl_incl@@\pp.h"\
    "@@perl_incl@@\pp_proto.h"\
    "@@perl_incl@@\proto.h"\
    "@@perl_incl@@\reentr.inc"\
    "@@perl_incl@@\regexp.h"\
    "@@perl_incl@@\scope.h"\
    "@@perl_incl@@\sv.h"\
    "@@perl_incl@@\sys\socket.h"\
    "@@perl_incl@@\thrdvar.h"\
    "@@perl_incl@@\thread.h"\
    "@@perl_incl@@\utf8.h"\
    "@@perl_incl@@\warnings.h"\
    "@@perl_incl@@\win32.h"\
    "@@perl_incl@@\win32iop.h"\
    "@@perl_incl@@\win32thread.h"\
    "@@perl_incl@@\xsub.h"\
*/};
...
else
{
    ...
    else
    {
        ...
        var makefileExt = ".vc6";
        var makefile_depName = 'makefile.dep';
        ...
        s_makefile_vc6 = s_makefile_vc6.replace(/@@makefile_depName@@/g, makefile_depName);
        ...
        // Generate makefile.dep
        var msvcInclude = msvcDir + "\\Include\\";
        var s_makefile_dep = GetHereDoc(makefile_dep);
        s_makefile_dep = s_makefile_dep.replace(/@@makefileName@@/g, makefileName);
        s_makefile_dep = s_makefile_dep.replace(/@@makefileExt@@/g, makefileExt);
        s_makefile_dep = s_makefile_dep.replace(/@@msvcInclude@@/g, msvcInclude);
        s_makefile_dep = s_makefile_dep.replace(/    @@perldep@@\r\n/, '');
        WriteToFile(scriptPath + makefile_depName, s_makefile_dep, FileFormatASCII);
        ...
        // Read the directory where Perl installed
        ...
        else
        {
            ...
            // Generate makeperl.dep
            var msvcInclude = AppendPath(msvcDir, "\\Include\\");
            var s_makefile_dep = GetHereDoc(makefile_dep);
            s_makefile_dep = s_makefile_dep.replace(/@@makefileName@@/g, makefileName);
            s_makefile_dep = s_makefile_dep.replace(/@@makefileExt@@/g, makefileExt);
            s_makefile_dep = s_makefile_dep.replace(/@@msvcInclude@@/g, msvcInclude);
            var s_perldep = GetHereDoc(perldep);
            s_perldep = s_perldep.replace(/@@perl_incl@@/g, perl_incl);
            s_makefile_dep = s_makefile_dep.replace(/    @@perldep@@/, s_perldep);
            WriteToFile(scriptPath + makefile_depName, s_makefile_dep, FileFormatASCII);
        }
    }
}
