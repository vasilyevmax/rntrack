...
typedef enum { ACT_ERROR,
               ACT_MOVE, ACT_COPY, ACT_DELETE, ACT_REWRITE, ACT_NEWMSG,
               ACT_IGNORE, ACT_DISPLAY, ACT_ROUTE, ACT_FLAG, ACT_WRITEFILE,
               ACT_CALL, ACT_DELETEATTACH, ACT_CHANGEPATH, ACT_MOVEATTACH,
               ACT_SPLIT, ACT_ADDFILE, ACT_ADDNOTE, ACT_DELFILE, ACT_POLL,
               ACT_COPYATTACH, ACT_RECODE, ACT_SCRIPT, ACT_ROUTEFBOX, ACT_TOLOWERPATH,
	       ACT_TOUPPERPATH, ACT_COPYATTACHFBOX, ACT_MOVEATTACHFBOX, ACT_ROUTEHUB,
	       ACT_ADDKLUDGE
} tAct;
...
inline   uint MaxMsgSize(void) { if (_MaxMsgSize == 0) return ::MaxMsgSize; else return _MaxMsgSize; };
inline   uint MaxPktSize(void) { if (_MaxPktSize == 0) return ::MaxPktSize; else return _MaxPktSize; };
