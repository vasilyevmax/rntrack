...
char *tmt, *tmt2;
   ...
   rm.orig.zone = (unzigned short)(m._FromAddr.Zone());
   rm.orig.net = (unzigned short)(m._FromAddr.Net());
   rm.orig.node = (unzigned short)(m._FromAddr.Node());
   rm.orig.point = (unzigned short)(m._FromAddr.Point());
   rm.dest.zone = (unzigned short)(m._ToAddr.Zone());
   rm.dest.net = (unzigned short)(m._ToAddr.Net());
   rm.dest.node = (unzigned short)(m._ToAddr.Node());
   rm.dest.point = (unzigned short)(m._ToAddr.Point());
